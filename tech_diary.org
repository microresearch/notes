...
- 2n3055 with 100ohm 1watt resistor+ and op amp buffer - works good
  for cv control on nichrome wire from eurorack but 3055 will need heatsink

** to order

general: 2n3904, 10k resistors, protoboard for logger
power stuff, cases, plugs, sockets for final session
