...
+using avr-gcc/example makefile: https://www.pjrc.com/teensy/gcc.html+ - this is notr for ARM teensy
...
*For zx81 boot thing on teensy (emulated ROM with earthboot)*
