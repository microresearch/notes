...
Updated to replace new_skry 17/2/2022:

- we have cosmic ray interrupt (rising) on pin 2, serial from gps (5v) on pin 3 and sd card on usual pins with CS as pin 4
...
#define ARDUINO_USD_CS 4 // uSD card CS pin (pin 10 on SparkFun GPS Logger Shield)
...
#define LOG_FILE_PREFIX "monk" // Name of the log file.
...
char * log_col_names[LOG_COLUMN_COUNT] = {
  "longitude", "latitude", "altitude", "speed", "course", "date", "time", "satellites", "cosmic"
}; // log_col_names is printed at the top of the file.

//////////////////////
// Log Rate Control //
//////////////////////
#define LOG_RATE 2000 // Log every 2 seconds
...
#define ARDUINO_GPS_RX 5 // GPS TX, Arduino RX pin wrong way round here but
#define ARDUINO_GPS_TX 3 // GPS RX, Arduino TX pin
SoftwareSerial ssGPS(ARDUINO_GPS_TX, ARDUINO_GPS_RX); // Create a SoftwareSerial - on pin 3 as pin 2 is interrupt
