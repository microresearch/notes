* for licht/breath and AC - larger pots, jaqcks, knobs:

- licht: 1x 100k lin: order35 (15stock), 2x PJ301BM/erthenvar

- breath: 2x regular 10k, 1x PJ301BM

we have 90x PJ301BM = 50x3=150 for full run, 20x3=60 for first - order 60!

- AC: 8x regular 10k, Thonkiconn Mono 3.5mm Audio Jacks (PJ398SM) (x32) - we have 220 odd so far -> 6

knobs: Light Gray (D-Shaft) - 1900h Plastic Knob: 200+

we need euro connectors:
...
8		CP1_Small-device-allcolours-rescue	C1 C4	47u	SMD-1206_Pol	2	- we have 6.3V?
...
X-DC BU sockets (correct ones):     DC-EBU 072339 _ORDERED segor?

100n

X-small 10UF -> KS-A 10U 35 x2
