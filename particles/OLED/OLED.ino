...
void get_time() 
{
  ...
  u8x8log.print("\f");			// \f = form feed: clear the screen
    ...
    u8x8log.print("Total Count: ");
    u8x8log.print(count);
    u8x8log.print("\n");
    u8x8log.print("Uptime: ");
  ...
  u8x8log.print((String) ((interrupt_timer - start_time) / 1000 / 3600) + ":" + min_char + ":" + sec_char);
  u8x8log.print("\n");
  
  if (count == 0) {
    //    u8x8log.println("Hi, I'm "+(String)detector_name);
    }
      ...
      if (last_sipm_voltage > 180){
          u8x8log.print("===---- WOW! ----===");}
            ...
            if (MASTER == 1) {u8x8log.print("M");}
            if (SLAVE  == 1) {u8x8log.print("S");}
            for (int i = 1; i <=  (last_sipm_voltage + 10) / 10; i++) {u8x8log.print("-");}}
      u8x8log.print("");
      u8x8log.print("\n");
  }
  ...
  u8x8log.print("Rate: ");
  u8x8log.print(tmp_average);
  u8x8log.print("\n");
  u8x8log.print("+/-");
  u8x8log.print(tmp_std);
  u8x8log.print("\n");
  //  u8x8log.display();
