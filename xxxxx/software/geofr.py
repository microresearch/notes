...
# dict for figures
figdict={'1101': ['Puer/le peauceau/3','Mars','Fire','Aries','+','Boy, yellow, beardless'], '1010': ['Amissio/la perte/6','Venus','Earth','Taurus','-','Loss, comprehended without'], '0010': ['Albus/le blanc/14','Mercury','Air','Gemini','-','White, fair'], '0000': ['Populus/la foule/16','Moon','Water','Cancer','-','People, congregation'], '0011': ['Fortuna Major/la grande fortune/13','Sun','Fire','Leo','+','Greater fortune, greater aid,safeguard entering'], '0110': ['Conjunctio/la reunion/10','Mercury','Earth','Virgo','+','Conjunction, assembling'], '1011': ['Puella/la pucelle/5','Venus','Air','Libra','+','A girl, beautiful'], '0100': ['Rubeus/la rouge/12','Mars','Water','Scorpio','-','Red, reddish'], '0101': ['Acquisitio/le gain/11','Jupiter','Fire','Sagitarrius','+','Obtaining, comprehending without'], '1001': ['Carcer/la prison/7','Saturn','Earth','Capricorn','+','A prison, bound'], '0001': ['Tristitia/la tristesse/15','Saturn','Air','Aquarius','-','Sadness, damned, cross'], '1000': ['Laetitia/la joie/8','Jupiter','Water','Pisces','-','Joy, laughing, healthy, bearded'], '1110': ['Cauda Draconis/la queue de dragon/2','Saturn & Mars','Fire','Scorpio','-','The threshold lower, or going out'], '0111': ['Caput Draconis/la test de dragon/9',' Jupiter & Venus','Earth','Capricorn','+','The Head, the threshold entering, the upper threshold'], '1100': ['Fortuna Minor/la petite fortune/4','Sun','Fire','Leo','-','Lesser Fortune, lesser aid, safeguard going out'], '1111': ['Via/la voie/1','Moon','Water','Cancer','+','Way, journey']}
...
#print sorted(figdict.keys())

fog=dict(sorted(figdict.items()))
#print fog

for x in range(16):
#chosen=next(iter(figdict))
    chosen = list(fog.keys())[x]
